################################################################################
## extract reads per gene for each samples and merge read count files
################################################################################
################################################################################
...
# define rule to merge reads from all samples 
# sample names are the path to files in order that samples are assigned 
...
# define rule to merge genes in first column
# I used this file for the MDS plot -- I had to adjust sample names a bit in first row prior to MDS plot 
